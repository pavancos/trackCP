...
function BatchReport({ studentsInfo, isFetchedFromAPI }) {
    ...
    const [isContestFiltered, setIsContestFiltered] = useState(false);
    const [whichContestPlatform, setWhichContestPlatform] = useState('codechef');
    const [whichContestSelected, setWhichContestSelected] = useState('');
    ...
    return (
        <div className="mt-6 m-3">
            <form onSubmit={handleSubmit(handleFormSubmit)} className="max-w-md mx-auto p-4 mb-2 border rounded-md ">
                        ...
                        <select
                            ...
                            onChange={(e) => {
                                if (e.target.value !== "all") {
                                    setIsContestFiltered(true);
                                    setWhichContestPlatform(e.target.value);
                                }else{
                                    setIsContestFiltered(false);
                                }
                            }}
                        >
                ...
                {/* Select which contest to display */}
                {
                    isContestFiltered && isSubmitted &&  
                    (whichContestPlatform === 'all' || (whichContestPlatform === 'leetcode' && hasLeetcode) || (whichContestPlatform === 'codechef' && hasCodechef) || (whichContestPlatform === 'codeforces' && hasCodeforces)) &&
                    <div>
                        ...
                        >
                            {
                                uniqueContests[whichContestPlatform].map((contest) => {
                                    return (
            ...
            </form>
            {
                ...
                <>
                    ...
                    >
                        {
                            isContestFiltered && whtplatform!=="all" ?
                            <>
                            <h1>Hello</h1>
                            {
